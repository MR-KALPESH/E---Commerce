...
export default function AddBlogPage() {
  ...
  const [author, setAuthor] = useState("CozyCommerce Admin");
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between pb-5 border-b border-gray-3">
        <div>
          <h1 className="text-heading-5 font-bold text-dark">Add New Blog</h1>
          <p className="text-xs text-dark-4">Publish a new article to your blog</p>
        </div>
        <Link
          href="/admin/blogs"
