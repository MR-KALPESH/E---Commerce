...
export default function AddProductPage() {
  ...
  const [variants, setVariants] = useState<Variant[]>([
    { image: "", color: "", size: "", isDefault: true },
  ]);
  ...
  const addVariant = () => {
    setVariants([...variants, { image: "", color: "", size: "", isDefault: false }]);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const productBody = {
        ...
        offers: offersInput ? offersInput.split(",").map((o) => o.trim()) : [],
        categoryId: categoryId ? parseInt(categoryId, 10) : undefined,
        productVariants: variants,
      };

      await axios.post("/api/admin/products", productBody);
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-dark-4 text-sm mt-1">Create a new product on the storefront.</p>
        </div>
        <Link
          href="/admin/products"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Organic Rosewater Facial Toner"
                  />
                </div>
